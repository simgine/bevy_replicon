...
- Move `NetworkStats` from `shared::backend::connected_client` to `shared::backend`. It's now a separate resource from `RepliconClient`.
...
[unreleased]: https://github.com/simgine/bevy_replicon/compare/v0.34.4...HEAD
